...
time_slots = (
    ...
    ('11:00 - 11:55', '11:00 - 11:55'),
    ('12:00 - 12:55', '12:00 - 12:55'),
    ('1:00 - 2:00', '1:00 - 2:00'),
    ('2:00 - 2:55', '2:00 - 2:55'),
    ('3:00 - 3:55', '3:00 - 3:55'),
    ('4:00 - 4:55', '4:00 - 4:55'),
...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='11:00 - 11:55')
...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='Class test 1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Class test 1')
                    sc.marks_set.create(name='Class test 2')
